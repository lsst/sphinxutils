...
@click.pass_context
def main(ctx: click.Context, root_project_dir: str, verbose: bool) -> None:
...
@click.option(
    ...
    help=("Toggle symlinking package documentation directories (disable for debugging only)."),
    default=True,
)
@click.option(
...
@click.option(
    ...
    help=("Use doxygen.conf.in files in packages rather than the sconsUtils-generated doxygen.conf files."),
    default=True,
)
@click.option(
    "--doxygen-conf",
...
def build(
    ctx: click.Context,
    skip: list[str],
    enable_doxygen_conf: bool,
    enable_doxygen: bool,
    enable_symlinks: bool,
    enable_sphinx: bool,
    use_doxygen_conf_in: bool,
    doxygen_conf_defaults_path: str | None,
    dox: list[str],
    skip_dox: list[str],
...
def clean(ctx: click.Context) -> None:
    ...
    dirnames = [os.path.join(root_project_dir, dirname) for dirname in dirnames]
